package com.semanticsqaure.datetime;
...
public class DateTimeDemo {
	...
	private static void testDateTimeAPI() {
		...
		// Other methods: plus & minus methods, isBefore, isAfter
		 ...
		 // get returns an int 
		 System.out.println("year again: " + newExpiryDate.get(ChronoField.YEAR)); //ChronoField is enum
		 ...
		 // parse string it even gives localDate pattern also
