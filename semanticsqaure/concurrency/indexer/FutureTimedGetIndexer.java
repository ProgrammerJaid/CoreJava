package com.semanticsqaure.concurrency.indexer;
...
public class FutureTimedGetIndexer {
	...
	public static void main(String[] args) {
		...
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2000, "Taming Tiger, Part 2", "https://docs.oracle.com/javase/tutorial/java/javaOO/nested.html", "http://www.javaworld.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2001, "How do I import a pre-existing Java project into Eclipse and get up and running?", "https://www.rediff.com/business/report/coronavirus-maruti-reports-47-plunge-in-march-sales/20200401.html", "http://www.stackoverflow.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2002, "Interface vs Abstract Class", "https://www.msn.com/en-in/travel/news/how-remote-workers-are-ticking-off-travel-bucket-lists/ar-AAXN7Mk", "http://mindprod.com"));
		futureTimedGetIndexer.add(futureTimedGetIndexer.createWeblink(2004, "Virtual Hosting and Tomcat", "https://www.mansionglobal.com/articles/rihanna-snaps-up-her-neighbors-house-for-10-million-226768", "http://tomcat.apache.org"));
