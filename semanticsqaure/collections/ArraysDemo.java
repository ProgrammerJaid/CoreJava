...
public class ArraysDemo {
		...
		private static void sequential() {
			...
			//strings.remove(0);  gives Unsupported operation exception cannot be modified
			//strings.add("a");
			strings.set(0, "john");
			...
			List<String> fixedList = Arrays.asList(new String[3]);	//Creating fixed length array
		...
		private static void parallel() {
			...
			Arrays.parallelPrefix(iArray, (IntBinaryOperator) IntBinaryOperatorImpl);
			...
			Arrays.parallelSetAll(iArray, (IntUnaryOperator) intUnaryOperatorImpl);
