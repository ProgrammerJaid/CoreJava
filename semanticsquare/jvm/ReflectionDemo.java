...
public class ReflectionDemo {
	...
	public static void demoClassObjectAccess() {
	    ...
	    // Using objectRef.getClass()
	 	String[] strArray = {"a", "b", "c"};		//strArray is object array as arrays are object in java
	 	System.out.println("\nstrArray.getClass().getName(): " + strArray.getClass().getName());
	    
	    // Using for Class.forName
	    Class clazz = null;
	    try {
		    clazz = Class.forName("com.semanticsquare.jvm.UserJvm");		    
	...
	public static void demoCoreReflection(Class clazz) throws InstantiationException, 
		...
		Constructor<UserJvm> userConstructor = clazz.getDeclaredConstructor(int.class, String.class, String.class, String.class, String.class);
		@SuppressWarnings("unchecked")
		UserJvm user = userConstructor.newInstance(101, "john", "john@semanticsquare.com", "male", "user");
	...
	public static void main(String[] args) throws Exception {
		...
		demoCoreReflection(Class.forName("com.semanticsquare.jvm.UserJvm"));
	}
}
